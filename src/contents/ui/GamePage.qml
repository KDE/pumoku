...
Kirigami.Page {
    ...
    function finish() {
        ...
        if (game.hintStatus & game.hintStatusAutoSolved) {
            ...
            finishText = i18nc("%1 is the step count", "You solved this Sudoku (with a bit of help) in %1 steps.", stepcount);
            ...
            finishText = i18nc("%1 is the step count", "You solved this Sudoku with no hints or help in %1 steps.", stepcount);
