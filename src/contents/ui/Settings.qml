...
FormCard.FormCardPage {
    ...
    FormCard.FormCard {
        FormCard.FormSwitchDelegate {
            text: i18nc("@option:check describing which kind of cells should be highlighted. Houses are the rows, columns and blocks the cell belongs to.", "Houses of a selected cell")
